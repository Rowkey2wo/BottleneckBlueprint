    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="text-sm font-mono text-[#8BA8C4] hover:text-[#00D4FF] transition-colors duration-200 tracking-wider uppercase relative group"
            >
              {link.label}
        ...
        <div className="hidden md:flex items-center gap-4">
          <Link
            href="#chatbot"
            className="relative px-5 py-2 text-sm font-mono font-semibold text-[#050A14] bg-[#00D4FF] hover:bg-[#FF6B35] transition-colors duration-300 tracking-wider uppercase overflow-hidden group"
        ...
        <div className="md:hidden bg-[#050A14]/95 backdrop-blur-md border-t border-[#00D4FF]/20 px-6 py-4 flex flex-col gap-4">
          {navLinks.map((link) => (
            <Link
              ...
              className="text-sm font-mono text-[#8BA8C4] hover:text-[#00D4FF] transition-colors tracking-wider uppercase py-2 border-b border-[#00D4FF]/10"
            >
              {link.label}
            </Link>
          ))}
          <Link
            href="#chatbot"
            className="mt-2 text-center px-5 py-2.5 text-sm font-mono font-semibold text-[#050A14] bg-[#00D4FF] hover:bg-[#FF6B35] transition-colors duration-300 tracking-wider uppercase"
          >
            Analyze My PC →
          </Link>
        </div>
